...
void decodeByProto(std::string& pMsg) {
	...
	try {
		...
		*/
		...
		//               address
		//               port_value
 		std::cout << "\n+++++++ Start ===== Print the passed protobuf data=====" << std::endl;
 		std::cout << "TraceWrapper->socket_streamed_trace_segment" << std::endl;
 		std::cout << "  trace_id=" << new_segment.socket_streamed_trace_segment().trace_id() << std::endl;
 		std::cout << "  event:" << std::endl;
    		...
    		std::cout << "    connection_per_event:" <<  std::endl;
...
int main() {
    ...
    std::cout << "main: Streamed trace, enter" << std::endl;
